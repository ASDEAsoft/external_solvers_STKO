...
def makeXObjectMetaData():
	...
	def mka(name, type, group, body=''):
		...
		a.description = (
			...
			html_par(body) +
			html_par(html_href("https://opensees.github.io/OpenSeesDocumentation/user/manual/model/elements/E_SFI_MVLEM_3D.html", 'E_SFI_MVLEM_3D Element')+'<br/>') +
			html_end()
			)
		return a
