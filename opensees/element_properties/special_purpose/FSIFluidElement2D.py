...
def getNodalSpatialDim(xobj, xobj_phys_prop):
	return [(2,1),(2,1),(2,1),(2,1)]	#[(ndm, ndf)...]
...
def writeTcl(pinfo):
	...
	if (elem.geometryFamilyType() != MpcElementGeometryFamilyType.Quadrilateral) or (len(elem.nodes) !=4):
		raise Exception('Error: invalid type of element or number of nodes. It should be a linear quadrilateral element')
	...
	pinfo.out_file.write('{}element FSIFluidElement2D {} {} {} {} {} {} -thickness {}\n'.format(
