...
if {[lindex $flags1 0] == 1} { pattern Plain 1 2 -fact 0.5 { load 2 [lindex $imps 0] 0 } }; # S11
if {[lindex $flags1 1] == 1} { pattern Plain 2 2 -fact 0.5 { load 3 0 [lindex $imps 1] } }; # S22
if {[lindex $flags1 2] == 1} { pattern Plain 3 2 -fact 0.5 { load 3 [lindex $imps 2] 0 } }; # S12
...
if {[lindex $flags1 2] == 2} { if {[lindex $flags2 2] == 2} { pattern Plain 30 2 { sp 3 1 [lindex $imps 2] } } }; # 2*E12
...
if {[lindex $flags1 2] == 2} { if {[lindex $flags2 2] == 1} { pattern Plain 300 1 { sp 3 1 1.0 } } }; # 2*E12
