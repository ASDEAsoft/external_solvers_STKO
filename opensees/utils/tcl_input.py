...
class auto_generated_element_data:
	def __init__(self):
		# this list containts the IDs of the auto-generated elements
		self.elements = []
		# Added: massimo 9/11/2021
		# since the auto-generated elements are not in the STKO mesh, we can add
		# extra information if necessary
		# element nodal positions: list[tuple(node_id, tuple(x,y,z))]
